...
public:
	...
	void MoveTetromino(RenderWindow& window, Sprite tetromino[], Texture red, int& rotation, float& x, float& y, float& z, float& v, float& switchtime, float& elaspedtime, RectangleShape& bg, RectangleShape& Grid, bool& checkboard)override;
...
void Tetromino_Red::RotateTetromino(RenderWindow& window, Sprite tetromino[], Texture red, int& rotation, float& x, float& y, float& z, float& v, RectangleShape& bg, RectangleShape& Grid)
{
	...
	Draw(window, red, bg, Grid, tetromino);
	return;
}

void Tetromino_Red::MoveTetromino(RenderWindow& window, Sprite tetromino[], Texture red, int& rotation, float& x, float& y, float& z, float& v, float& switchtime, float& elaspedtime, RectangleShape& bg, RectangleShape& Grid, bool& checkboard)
{

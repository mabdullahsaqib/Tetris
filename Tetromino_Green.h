...
public:
	...
	void MoveTetromino(RenderWindow& window, Sprite tetromino[], Texture green, int& rotation, float& x, float& y, float& z, float& v, float& switchtime, float& elaspedtime, RectangleShape& bg, RectangleShape& Grid, bool& checkboard, float levelspeed)override;
...
void Tetromino_Green::MoveTetromino(RenderWindow& window, Sprite tetromino[], Texture green, int& rotation, float& x, float& y, float& z, float& v, float& switchtime, float& elaspedtime, RectangleShape& bg, RectangleShape& Grid, bool& checkboard, float levelspeed)
{
